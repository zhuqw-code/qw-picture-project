...
/** editPicture PUT /api/picture/edit */
...
export async function listSpaceLevelUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResultListSpaceLevel_>('/api/picture/list/level', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function createPictureOutPaintingTaskUsingPost(
  ...
  return request<API.BaseResultCreateOutPaintingTaskResponse_>(
...
export async function getPictureOutPaintingTaskUsingGet(
  ...
  return request<API.BaseResultGetOutPaintingTaskResponse_>('/api/picture/out_painting/get_task', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function searchPictureByColorUsingPost(
  ...
  return request<API.BaseResultListPictureVO_>('/api/picture/search/color', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
